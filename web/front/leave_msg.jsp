        ...
        <div class="right">
            <ul class="layui-nav">
                ...
                <li id="login_yes" class="layui-nav-item" style="display: none;">
                    <a><img id="figureurlQq1" class="layui-nav-img" src="" alt="图片加载失败"><b id="nickname">您的昵称</b></a>
                    <dl class="layui-nav-child">
                        <!--
                        <dd>
        ...
        <div class="layui-row">
            <div class="layui-col-md9 layui-col-sm8 layui-col-xs12 content-left">
                <p class="intitle"><b>您现在的位置是：</b>
                    ...
                    >
                    <a href="leave_msg.jsp">留言区</a>
                </p>
                <hr class="layui-bg-red">
                <div class="article_detail">
                    <!-- 评论模块 -->
                    <div id="comment_editor" class="comment_editor">
                        <textarea placeholder="留言内容" id="article_editor" name="content"
                                  class="layui-textarea  article_editor" style=" height: 150px; "></textarea>
                    </div>
                    <textarea id="uid" style="display: none;"></textarea>
                    <button class="layui-btn layui-btn-danger layui-submit layui-unselect">提交留言</button>
                    <a class="layui-clear"></a>
                </div>
                <!-- 评论回复 -->
                <strong class="layui-unselect">全部留言</strong>
                <hr class="layui-bg-red">
                <!-- 评论回复列表 -->
                <div id="comment" class="comment">
                    <ul id="comment_list">
                        <li>
                            <a class="user_header_img"><img src="${pageContext.request.contextPath}/res/images/my/favicon.ico"/></a>
                            <a class="user_nickname" title="dawa大娃bigbaby" uid="001">dawa大娃bigbaby</a>:
                        ...
                        <li>
                            <a class='user_header_img'><img src='${pageContext.request.contextPath}/res/images/my/favicon.ico'/></a>
                            <a class='user_nickname' title='作者' uid='002'>dawa大娃bigbaby</a>回复
                    ...
                    <div class="grid" id="grid">
                        ...
                        <div class="content">
                            ...
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4">
										<a href="article_list.jsp" atitle="文章"><b>32</b><i
                                                class="layui-icon">&#xe60a;</i></a>
									</span>
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4">
										<a href="classify.jsp" atitle="分类"><b>8</b><i
                                                class="layui-icon">&#xe61d;</i></a>
									</span>
...
<footer class="footer">
    ...
    <div class="recentuser layui-hide-xs" id="foot_recentuser">
        ...
        <ul>
            ...
            <li>
                <img src="${pageContext.request.contextPath}/favicon.ico" alt="今天没空"
                     title="今天没空"/>
                <div class="recent_nickname">今天没空</div>
            </li>

            <li>
                <img src="${pageContext.request.contextPath}/favicon.ico" alt="朝雾轻寒"
                     title="朝雾轻寒"/>
                <div class="recent_nickname">朝雾轻寒</div>
            </li>

            <li>
                <img src="${pageContext.request.contextPath}/favicon.ico" alt="︶往事随风︶"
                     title="︶往事随风︶"/>
                <div class="recent_nickname">︶往事随风︶</div>
            </li>

            <li>
                <img src="${pageContext.request.contextPath}/favicon.ico" alt="老虎打猫咪"
                     title="老虎打猫咪"/>
            ...
            <li>
                <img src="
                ${pageContext.request.contextPath}/favicon.ico" alt="AF"
                     title="AF"/>
                <div class="recent_nickname">AF</div>
            </li>

            <li>
                <img src="${pageContext.request.contextPath}/favicon.ico" alt="."
                     title="."/>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/lay/system/web/leave_msg.js"></script>
