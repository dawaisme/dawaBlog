...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/web/article_detail.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/wangEditor/wangEditor.css?v=1.15"/>
</head>
        ...
        <div class="layui-row">
            <div class="layui-col-md8 layui-col-sm8 layui-col-xs12 content-left">
                <p class="intitle"><b>您现在的位置是：</b>
                    <a href="${pageContext.request.contextPath}/front/index.jsp">首页</a>
                    >
                    <a href="#"><span class="title">文章标题</span></a>
                </p>
                <hr class="layui-bg-red">
                <div class="article_detail">
                    <h2 class="title" id="article_id" article_id="1538898727015"><span class="title">文章标题</span></h2>
                    <!-- 文章的一些基本信息 -->
                    <p>
                        <a title="作者"><i class="layui-icon">&#xe612;</i><span id="author">大娃o</span></a>
                        <a title="发布时间"><i class="layui-icon">&#xe60e;</i><span
                                id="create_time">2019年1月1日14:17:09</span></a>
                        <span>
									<a title="评论量" href="#comment_editor"><i class="layui-icon">&#xe606;</i>0</a>
									<a title="点击量" href="#comment">共<b>0</b>人围观</a>
								</span>
                    ...
                    <div id="nextinfo" class="nextinfo">
                        <p>上一篇：<a href="javascript:" id="prev">本站静态资源</a></p>

                        <p>下一篇：<a href="javascript:" id="next">Spark环境搭建上手</a></p>
                    </div>
                    <!-- 评论模块 -->
                    <div id="comment_editor" class="comment_editor">
                        <textarea placeholder="评论内容" id="article_editor" name="content"
                                  class="layui-textarea  article_editor" style=" height: 150px; "></textarea>
                    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/lay/system/web/article_detail.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/res/jquery-3.3.1/jquery-3.3.1.js"></script>
<script>
    //获取分类,标签
    initData();

    var a_id = getUrlParam("a_id"); // 从当前url参数中获取文章id.
    //ajax读取文章详情.
    $.ajax({
        url: '/admin/admin.do?cmd=getArticleById',
        type: 'post',
        data: {"id": a_id},
        success: function (data) {
            console.log(data);
            $("span.title").html(data.data.a_title);
            $("#author").html(data.data.a_autor);
            $("div.article_content").html(data.data.a_content);
            $("#create_time").html(data.data.create_date);
