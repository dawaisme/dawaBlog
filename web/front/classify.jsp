...
<head>
    ...
    <title>dawa大娃bigbaby-文章分类</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/web/clssify.css"/>
</head>
    ...
    <div class="layui-container mycontent">
        <div class="layui-row">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
                <legend><strong>dawa大娃bigbaby(triedblog)</strong> 目前共有分类：6 类</legend>
            </fieldset>
            <div class="layui-col-md9 layui-col-sm8 layui-col-xs12 content-left">
                <a href="https://waylee.net/category/jsz/%e5%89%8d%e7%ab%af/" data-uk-tooltip="">前端 (9)</a>
                <a href="https://waylee.net/category/jsz/" data-uk-tooltip="">折腾笔记 (267)</a>
                <a href="https://waylee.net/category/nofl/" title="" data-uk-tooltip="">未分类文章 (69)</a>
                <a href="https://waylee.net/category/qw/" data-uk-tooltip="">短篇故事 (452)</a>
                <a href="https://waylee.net/category/yp/" title="" data-uk-tooltip="">视频音乐 (54)</a>
                <a href="https://waylee.net/category/diary/" title="" data-uk-tooltip="">随手记录 (253)</a>
            </div>
                    ...
                    <div class="grid" id="grid">
                        ...
                        <div class="content">
                            ...
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4">
										<a href="article_list.jsp?__hbt=1524650296533" atitle="文章"><b>32</b><i
...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/lay/system/web/classify.js"></script>
