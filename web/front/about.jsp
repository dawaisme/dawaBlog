...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/web/about.css"/>
</head>
        ...
        <div class="layui-row">
            <div class="layui-col-md12 layui-col-sm12 layui-col-xs12 content-left">
                <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
                    <legend><strong>关于博客</strong></legend>
                </fieldset>
                <div class="about">
                    <p class="title">
                        一款JAVA的个人博客，记录学习、生活、人生路
                    </p>

                    <p class="time">本站已苟活：<span id="yunxing"></span></p>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/lay/system/web/about.js"></script>
