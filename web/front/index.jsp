...
<head>
    ...
    <title>dawa大娃bigbaby-个人博客</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/web/index.css"/>
    <style>
        #pageSplit {
            padding-bottom: 20px;
            float: right;
        ...
        <div class="right">
            <ul class="layui-nav">
                ...
                <li id="login_no" class="layui-nav-item" style="display: none;">
                    <a href="javascript:" onchange="return false" id="login">
                        <img src="${pageContext.request.contextPath}/res/images/my/nologin.png"
                ...
                <li id="login_yes" class="layui-nav-item" style="display: none;">
                    <a><img id="figureurlQq1" class="layui-nav-img" src="#" alt="图片为加载"><b id="nickname">您的昵称</b></a>
                    <dl class="layui-nav-child">
                        <!--
                        <dd>
...
<div class="scorllimgs">
    <img src="${pageContext.request.contextPath}/res/images/my/background37.jpg"/>
</div>
...
<div class="content">
    ...
    <div class="layui-container quoteoftheday layui-anim layui-anim-fadein">
        <span class="quotetitle layui-unselect">个人语录：</span>
        <i id="quoterefresh" class="layui-icon layui-icon-face-smile layui-unselect"></i>
        <a class="quotecontent">即使没有成功，也不会带有遗憾，因为曾经付出了...</a>
    </div>
    <!-- 帖子 -->
    <div class="layui-container mycontent">
        <div class="layui-row">
            ...
            <div class="layui-col-md8 layui-col-sm8 layui-col-xs12 content-left">
                ...
                <ul class="post-list" id="articleList">
                    <%--<c:forEach items="${sessionScope.pageBean.list}" var="article">
                        <li class="post-one">
                            <span class="label layui-unselect"><c>学习</c></span>
                            <h3 class="title animated">
                                <a class="animated" title="${article.a_title}"
                                   href="${pageContext.request.contextPath}/front/article_detail.jsp?a_id=${article.a_id}">
                                        ${article.a_title}</a>
                            </h3>
                            <div class="article_lable_show layui-unselect">
                                <span class="animated3" style="background-color: #fb7dff;">YARN</span>
                            </div>
                            <div class="post-desc">
                                <div class="summaryimg">
                                    <a href="javascript:" title="${article.a_title}"><img
                                            title="${article.a_title}" alt="${article.a_title}"
                                            src="${pageContext.request.contextPath}${article.a_image}"/></a>
                                </div>
                                <p class="post-desc-txt">
                                        ${article.a_brief}
                                </p>
                            ...
                            <div class="post-info">
                                <p class="post-info-left">
                                    <a href="javascript:;">
                                        <img title="${article.a_author}"
                                             src="${pageContext.request.contextPath}/res/images/my/login.jpg"/>
                                        <span class="author">${article.a_author}</span>
                                    </a>
                                </p>
                                <p class="post-info-right layui-unselect">
                                    <a><i class="layui-icon">&#xe705;</i><span
                                            class="num">${article.a_pviews}</span></a>
                                    <a><i class="layui-icon">&#xe637;</i><span
                                            class="time"> ${article.create_time}</span></a>
                                </p>
                            </div>
                        </li>
                    </c:forEach>--%>
            ...
            <div class="layui-col-md4 layui-col-sm4 layui-col-xs12 content-right">
                <div>
                    ...
                    <div class="grid" id="grid">
                        <h3></h3>
                        <div class="content">
                            <div class="myquote animated layui-unselect">
                                没有什么比年轻时候的贫穷更理直气壮的
                            </div>
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4">
					<a href="javascript:" atitle="文章">
						<i class="layui-icon layui-bg-orange">&#xe60a;</i>
						<b id="a_num">0</b>
						<b class="txt">文章</b>
					</a>
				</span>
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4">
					<a href="#right_fenlei" atitle="分类">
						<i class="layui-icon layui-bg-green">&#xe61d;</i>
						<b id="fl_num">0</b>
						<b class="txt">分类</b>
					</a>
				</span>
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4 no-right-border">
					<a href="#right_labels" atitle="标签">
						<i class="layui-icon layui-bg-cyan">&#xe64d;</i>
						<b id="bq_num">0</b>
						<b class="txt">标签</b>
					</a>
				</span>
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4">
					<a href="#foot_recentuser" atitle="访客">
						<i class="layui-icon layui-bg-blue layui-icon-user"></i>
						<b>24</b>
						<b class="txt">用户</b>
					</a>
				</span>
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4">
					<a href="javascript:" atitle="留言">
						<i class="layui-icon" style="background: #7266BA;">&#xe611;</i>
						<b>0</b>
						<b class="txt">留言</b>
					</a>
				</span>
                            <span class="layui-col-md4 layui-col-sm4 layui-col-xs4 no-right-border">
					<a href="#right_youzan" atitle="友站">
						<i class="layui-icon" style="background: #66DAFB;">&#xe650;</i>
						<b>0</b>
						<b class="txt">友站</b>
					</a>
				</span>
                    ...
                    <div class="hot-post">
                        ...
                        <div class="content">
                            <ul>
                                <li class="animated8">
                                    <a href="javascript:" title="Hadoop实战-浏览器统计" target="_blank"
                                       class="thumbnail-link">
                                        <img class="thumbnailside" title="Hadoop实战-浏览器统计" alt="Hadoop实战-浏览器统计"
                                             src="https://triedblog.oss-cn-beijing.aliyuncs.com/my/5.jpg" width="46"
                                             height="46" style="overflow: hidden;"/>
                                    </a>
                                    <div class="right-box">
                                        <h4 class="title">
                                            <a href="javascript:" title="Hadoop实战-浏览器统计">Hadoop实战-浏览器统计</a>
                                        </h4>
                                        <p class="time">
                            ...
                            <ol>
                                <div class="layui-row">
                                    <div class="layui-col-md6 layui-col-sm6 layui-col-xs6">
                                        <li>
                                            <a title="灰’s Blog" target="_blank" href="www.baidu.com">百度一下</a>
                                        </li>
                                        <li>
                                            <a title="灰’s Blog" target="_blank" href="www.Google.com">Google一下</a>
                                        </li>
                                    </div>
...
<footer class="footer">
    ...
    <div class="info">
        ...
        <span><a>© 2018 dawa大娃bigbaby-博客</a></span>
...
<div id="music163" class="animated">
    <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=450
            src="//music.163.com/outchain/player?type=0&id=383785579&auto=0&height=430"></iframe>
    <i class="layui-icon">&#xe6fc;</i>
</div>--%>
</body>
<script type="text/javascript" src="${pageContext.request.contextPath}/res/layui/layui.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/res/lay/system/public.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/res/lay/system/web/web.js"></script>
...
<script>
    ...
    layui.use(['laypage', 'layer'], function () {
        ...
        laypage.render({
            elem: 'pageSplit'
            , count: ${sessionScope.pageBean.allRows}
            , theme: '#FF5722'
            , limit: 5
            , jump: function (obj, first) {
                splitArticle(obj.curr, obj.limit);
            }
        });
    });

    //分页展示所有文章
    function splitArticle(currPage, pageSize) {
        $("#articleList").html("");
        $.ajax({
            url: '/front/front.do?cmd=getArticleList&page=' + currPage + '&pageSize=' + pageSize,
            type: 'post',
            dataType: 'json',
            success: function (data) {
                ...
                $.each(data.list, function (index, obj) {
                    ...
                    html += "" +
                        ...
                        "                            <span class=\"label layui-unselect\"><c>学习</c></span>\n" +
                        "                            <h3 class=\"title animated\">\n" +
                        "                                <a class=\"animated\" title=\" " + obj.a_title + " \"\n" +
                        "                                   href=\"${pageContext.request.contextPath}/front/article_detail.jsp?a_id=" + obj.a_id + "\">\n" +
                        "                                        " + obj.a_title + "</a>\n" +
                        "                            </h3>\n" +
                        "                            <div class=\"article_lable_show layui-unselect\" id=\"label" + index + "\">\n" +
                        "                            </div>\n" +
                        "                            <div class=\"post-desc\">\n" +
                        "                                <div class=\"summaryimg\">\n" +
                        "                                    <a href=\"javascript:\" title=\"" + obj.a_title + "\"><img\n" +
                        "                                            title=\"" + obj.a_title + "\" alt=\"" + obj.a_title + "\"\n" +
                        "                                            src=\"${pageContext.request.contextPath}" + obj.a_image + "\"/></a>\n" +
                        "                                </div>\n" +
                        "                                <p class=\"post-desc-txt\">\n" +
                        "                                        " + obj.a_brief + "\n" +
                        "                                </p>\n" +
                        ...
                        "                                <p class=\"post-info-left\">\n" +
                        "                                    <a href=\"javascript:;\">\n" +
                        "                                        <img title=\"" + obj.a_author + "\"\n" +
                        "                                             src=\"${pageContext.request.contextPath}/res/images/my/login.jpg\"/>\n" +
                        "                                        <span class=\"author\">" + obj.a_author + "</span>\n" +
                        "                                    </a>\n" +
                        "                                </p>\n" +
                        "                                <p class=\"post-info-right layui-unselect\">\n" +
                        "                                    <a><i class=\"layui-icon\">&#xe705;</i><span\n" +
                        "                                            class=\"num\">" + obj.a_pviews + "</span></a>\n" +
                        "                                    <a><i class=\"layui-icon\">&#xe637;</i><span\n" +
                        "                                            class=\"time\"> " + obj.create_time + "</span></a>\n" +
                        "                                </p>\n" +
                        "                            </div>\n" +
                        "                        </li>  ";

                    showTypeByAId("label"+index, obj.a_id);
                });
    ...
    //根据文章ID,显示文章类型.
    function showTypeByAId(id, aId) {
        $.ajax({
            url: '/admin/admin.do?cmd=getArticleById&id='+aId,
            type: 'post',
            // data: {"id": aId},
            dataType: 'json',
            success: function (data) {
                layer.closeAll();
                $.each(data.ids, function (index, obj) {
                    $("#" + id + "").append("<span class=\"animated3\" t-id='" + obj.t_id + "' t-color='" + obj.t_color + "' style=\"background-color: " + obj.t_color + ";\"> " + obj.t_name + "</span>");
                });
            }
        });
    }
