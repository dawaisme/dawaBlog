    ...
    <div class="layui-row">
        <div class="layui-col-md12">
            <div class="layui-card layui-anim layui-anim-upbit">
                <div class="layui-card-header">管理员列表
                    <span class="btn_right">
								...
								<button id="adduser" title="添加用户" class="layui-btn layui-btn-normal layui-btn-xs"><i
                    ...
                    <header>
                        <form class="layui-form" action="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="status" id="userStatus" title="状态">
                                        <option value=""></option>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input id="start" type="text" placeholder="开始时间" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input id="end" type="text" placeholder="结束时间" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/lay/system/admin/admin_list.js"></script>
</body>
