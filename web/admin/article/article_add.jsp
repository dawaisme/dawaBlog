...
<div class="layui-fluid">
    <div class="layui-card layui-anim layui-anim-upbit">
        <form id="f" class="layui-form" onsubmit="return false;" method="post" action="${pageContext.request.contextPath}/admin/admin.do?cmd=addArticle">
            <div class="layui-row">
                        ...
                        <div class="layui-form-item layui-row">
                            ...
                            <div class="layui-col-md2 layui-col-sm2 layui-col-xs12">
                                <div class="thumbBox" id="updateS">
                                    ...
                                    <img id="demo1" src="${pageContext.request.contextPath}/res/images/my/5.jpg" class="layui-upload-img thumbImg">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item layui-row">
                    ...
                    <div class="layui-form-item layui-row">
                        <div class="layui-col-md12 layui-col-sm12 layui-col-xs12">
                            <fieldset class="layui-elem-field">
                                ...
                                <div class="layui-form-item layui-field-box" id="lables"></div>
                            </fieldset>
                            <fieldset class="layui-elem-field">
                                <input type="hidden" id="classifyIds" name="classifyIds">
                                <legend style="font-size: 16px;"><strong>分类</strong></legend>
                                <div class="layui-form-item layui-field-box" id="classifys"></div>
                            </fieldset>
                            <fieldset class="layui-elem-field">
                                ...
                                <div class="layui-form-item layui-field-box">
                                    ...
                                    <input type="checkbox" name="is_top"  lay-skin="switch" lay-text="顶置|不顶置"
                                           title="是否置顶">
                                    <input type="checkbox" name="is_view" lay-skin="switch" lay-text="可见|不可见" checked
                                           title="是否可见" >
                                </div>
                                <div class="layui-form-item layui-field-box">
                                    <button class="layui-btn layui-btn layui-btn-sm layui-btn-normal" lay-submit
                                            lay-filter="formDemo"><i class="layui-icon layui-icon-release"></i> 确认发布
                                    </button>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/res/lay/system/admin/send_one_article_form.js"></script>
</body>
